    ...
    <div>
      ...
      <div>
        ...
        <div>
          ...
          <p>Price: $8.99</p>
          <button className='text-light' onClick={() => addToCart({ id: 2, name: "Product 2", price: 8.99 })}>
            Add to Cart
          </button>
        </div>
        <div>
          <h3>Pork Tacos</h3>
          <p>Price: $11.99</p>
          <button className='text-light' onClick={() => addToCart({ id: 2, name: "Product 2", price: 11.99 })}>
            Add to Cart
          </button>
        </div>
        <div>
          <h3>Green Curry</h3>
          <p>Price: $13.99</p>
          <button className='text-light' onClick={() => addToCart({ id: 2, name: "Product 2", price: 13.99 })}>
            Add to Cart
          </button>
        </div>
        {/* Display cart */}
